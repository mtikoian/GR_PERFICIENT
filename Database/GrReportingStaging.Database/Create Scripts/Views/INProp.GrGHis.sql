...
GO
/****** Object:  View [INProp].[GrGHis]    Script Date: 09/01/2009 12:34:09 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[INProp].[GrGHis]'))
DROP VIEW [INProp].[GrGHis]
GO
/*
CREATE VIEW [INProp].[GrGHis]
AS
Select 
