...
/****** Object:  StoredProcedure [dbo].[stp_R_BudgetOwner]    Script Date: 04/11/2012 04:52:50 ******/
...
History:	[yyyy-mm-dd]	: [Person]	:	[Details of changes made]
			...
			2012-04-11		: MChen		:	Rock Center originating region shows as local for the New York assets
...
BEGIN
	...
	UPDATE #LocalNonLocalMapping 
    SET LocalNonLocal = 'Local'
    WHERE OriginatingSubRegionName = 'Rock Center' AND AllocationSubRegionName = 'New York'
