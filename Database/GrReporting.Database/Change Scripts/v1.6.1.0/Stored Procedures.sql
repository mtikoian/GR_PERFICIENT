 ...
 */
 ...
 ----------------------------------------------------------
	/*	Beginning of dbo.stp_R_BudgetOwner */
 ----------------------------------------------------------
USE [GrReporting]
GO
/****** Object:  StoredProcedure [dbo].[stp_R_BudgetOwner]    Script Date: 03/25/2011 17:49:53 ******/
SET ANSI_NULLS ON
GO
...
IF  OBJECT_ID('tempdb..#LocalNonLocalMappings') IS NOT NULL
 ...
 ----------------------------------------------------------
  ...
  ----------------------------------------------------------
	/*	Beginning of dbo.stp_R_BudgetOriginator */
 ----------------------------------------------------------

/****** Object:  StoredProcedure [dbo].[stp_R_BudgetOriginator]    Script Date: 03/25/2011 18:09:19 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
