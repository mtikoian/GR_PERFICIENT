...
/****** Object:  StoredProcedure [dbo].[csp_IU_SCDSnapshotPropertyFundFTE]    Script Date: 08/14/2012 02:57:07 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[csp_IU_SCDSnapshotPropertyFundFTE]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[csp_IU_SCDSnapshotPropertyFundFTE]
GO
...
CREATE PROCEDURE [dbo].[csp_IU_SCDSnapshotPropertyFundFTE]
